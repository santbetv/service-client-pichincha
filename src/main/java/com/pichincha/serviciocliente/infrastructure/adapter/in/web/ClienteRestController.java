package com.pichincha.serviciocliente.infrastructure.adapter.in.web;

import com.pichincha.serviciocliente.application.dto.ClienteDTO;
import com.pichincha.serviciocliente.domain.port.in.mapper.ClienteResponseMapper;
import com.pichincha.serviciocliente.domain.port.in.web.WebPort;
import com.pichincha.serviciocliente.infrastructure.adapter.out.db.model.ClienteEntity;
import com.pichincha.serviciocliente.infrastructure.adapter.out.db.model.PersonaEntity;
...
import com.pichincha.serviciocliente.domain.port.out.db.ClienteService;
...
public class ClienteRestController implements WebPort {
    ...
    @Autowired
    public ClienteRestController(ClienteService iClienteService, ClienteResponseMapper clienteResponseMapper) {
